...
{   
    uint8_t         *y_ptr, r_ptr[HASH_SIZE], x_ptr[HASH_SIZE], 
                    prior_x[64], prior_hash[64], e_ptr[HASH_SIZE];
    ...
    if (0 == sha256_i(prior_x, prior_x_len, x_ptr, 0))                                          { return 0; }   /* x = H(y || j || 0) */
    if (0 == sha256_i(prior_x, prior_x_len, r_ptr, 1))                                          { return 0; }   /* x = H(y || j || 1) */
...
{   
    ...
    if (0 == concat_str_int(y_ptr, ylen, this->counter, prior_x, &prior_x_len))                 { return 0; }
    if (0 == sha256_i(prior_x, prior_x_len, x_ptr, 0))                                          { return 0; }   /* x = H(y || 0) */
    if (0 == sha256_i(prior_x, prior_x_len, r_ptr, 1))                                          { return 0; }   /* r = H(y || 1) */

    for (int i = 0 ; i < (int) msgnum ; i++) {
        if (0 == sha256_i(x_ptr, HASH_SIZE, xj_ptr, i))                                         { return 0; }   /* xj = H(x || i) */
        if (0 == sha256_i(r_ptr, HASH_SIZE, rj_ptr, i))                                         { return 0; }   /* rj = H(r || i) */
